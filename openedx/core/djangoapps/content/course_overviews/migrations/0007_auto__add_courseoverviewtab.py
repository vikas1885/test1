...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('course_overviews_courseoverviewtab', (
            ...
            ('course_overview', self.gf('django.db.models.fields.related.ForeignKey')(related_name='course_overview_tab', to=orm['course_overviews.CourseOverview'])),
        ))
    ...
    models = {
        ...
        'course_overviews.courseoverviewtab': {
            ...
            'course_overview': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'course_overview_tab'", 'to': "orm['course_overviews.CourseOverview']"}),
